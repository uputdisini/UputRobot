...
DEFAULT_WELCOME_MESSAGES = [
    "{first} Kambing Telah Datang!",  # Discord welcome messages copied
    "Udah Siap Untuk Di Entod Kah Kau Badjingan? {first} ?",
    "{first} Haloo Yatim.",
    "Ngapain Kau Pantek {first} Join Ke Sini?",
    "{first} Aku Suka Sama Kamu, Mwahh:*!",
    "{first} Telah Hadir Untuk Ikut Live Show💦.",
    "{first} Ngapain Kesini Tod, Mau Ikut Masuk Neraka?",
    ...
    "Selamat Datang Anak Pantek😭 {first}",
    "Selamat Datang, {first}. Keluarkan Sejanta Mu Mari Kita Perang.",
]
DEFAULT_GOODBYE_MESSAGES = [
    "Anak Anjing {first} Meninggalkan Grup.",
]
